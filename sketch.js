...
function draw() {
  ...
  if(estadoJogo===JOGAR){
   ...
   caminho.velocityX = -(60 + 2*distancia/150);
 ...
 ciclistaPrincipal.addAnimation("SahilRunning",img2CiclistaPrincipal);
    ...
    text("Clique em qualquer lugar para tentar de novo.",400,250)
...
function resett () {
  ...
  ciclistaPrinscipal.changeAnimation("SahilRunning",img1CiclistaPrincipal)
